module CompaniesHouseXmlgateway
  module Service
    class SubmissionStatus < CompaniesHouseXmlgateway::Service::Base
      API_CLASS_NAME = 'GetSubmissionStatus'
      SCHEMA_XSD = 'http://xmlgw.companieshouse.gov.uk/v2-1/schema/forms/GetSubmissionStatus-v2-5.xsd'
