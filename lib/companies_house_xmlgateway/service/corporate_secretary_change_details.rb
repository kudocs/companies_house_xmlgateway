module CompaniesHouseXmlgateway
  module Service
    class CorporateSecretaryChangeDetails < CompaniesHouseXmlgateway::Service::Form
      API_CLASS_NAME = 'OfficerChangeDetails'
      SCHEMA_XSD = 'http://xmlgw.companieshouse.gov.uk/v1-0/schema/forms/OfficerChangeDetails-v2-9-rc1.xsd'
